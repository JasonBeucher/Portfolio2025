...
export const ThemeSwitch = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-4 right-4 z-50 inline-flex h-12 w-12 items-center justify-center rounded-xl border border-white/15 bg-sky-600/10 dark:bg-white/10 backdrop-blur"
    >
      {theme === 'dark' ? (
