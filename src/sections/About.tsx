...
export const AboutSection = () => {
  ...
  return <div className='py-20 lg:py-28' id='about'>
    <div className='container'>
      <SectionHeader title="A Glimps Into My World" eyebrow="About Me" description="Learn more about who  I am, what i do and what inspire me" />
        ...
        <div className='grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8'>
          <Card className='h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2'>
            ...
            <div className='relative flex-1' ref={constraintRef}>
              {hobbies.map(hobby => ( 
                <motion.div key={hobby.title} className='inline-flex items-center gap-2 px-6 bg-white dark:bg-gradient-to-r from-[#ffc760] to-[#f0a800] rounded-full py-1.5 absolute' style={{ left: hobby.left, top: hobby.top }}
                drag
